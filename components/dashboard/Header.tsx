...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="flex items-center justify-between px-10 py-8 flex-wrap gap-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="font-display text-[28px] text-foreground tracking-[-0.3px]">
            {title}
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2.5">
        <div className="hidden sm:flex items-center gap-2 px-4 py-2.5 bg-card border border-border rounded-[10px] min-w-[220px] transition-colors hover:border-[rgba(42,36,32,0.14)] cursor-text">
        ...
        <button className="flex items-center gap-1.5 px-5 py-2.5 bg-primary text-primary-foreground rounded-[10px] text-[13px] font-medium hover:bg-[#8a7055] transition-colors">
