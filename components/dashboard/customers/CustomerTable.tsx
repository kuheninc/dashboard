...
export default function CustomerTable({ customers, onSelectCustomer, selectedCustomerId }: CustomerTableProps) {
  ...
  return (
    <div className="space-y-4">
      {/* Search */}
      <div className="flex items-center gap-2 bg-card border border-border rounded-lg px-4 py-2.5 max-w-sm">
          ...
          <table className="w-full min-w-[480px]">
            <thead>
              <tr className="bg-[rgba(166,139,107,0.05)]">
                ...
                <th className="text-left font-label text-[#9c9184] px-4 lg:px-5 py-3 hidden md:table-cell">
                  Email
                </th>
            ...
            <tbody>
              {filtered.map((customer) => (
                ...
                >
                  ...
                  <td className="text-[13px] text-muted-foreground px-4 lg:px-5 py-3 hidden md:table-cell truncate max-w-[180px]">
                    {customer.email ?? "\u2014"}
                  </td>
